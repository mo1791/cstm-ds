...
//  --------------------------------------------------------------------------
    ...
    forward_list<T>::forward_list(forward_list const& p_outer)
        : forward_list( std::begin(p_outer), std::end(p_outer) )
    {
...
//  --------------------------------------------------------------------------
    template <class T>
    auto forward_list<T>::operator=(forward_list p_list) -> decltype(auto)
    {
        swap(*this, p_list);
...
//  --------------------------------------------------------------------------
    ...
    {
        return not empty() ? std::optional{ m_head->data() } : std::nullopt;
    }
//  --------------------------------------------------------------------------
//  --------------------------------------------------------------------------
